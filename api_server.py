...
from src.risk_interpreter import classify_risk, generate_insights, top_contributors
    ...
    try:
        ...
        return PredictionResponse(
            ...
            positive_contributors=[
                Contributor(feature=name, value=value) for name, value in positive
            ],
            negative_contributors=[
                Contributor(feature=name, value=value) for name, value in negative
            ],
            insights=insights,
